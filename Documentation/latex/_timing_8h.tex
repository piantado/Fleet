...
\DoxyCodeLine{    In \mbox{\hyperlink{class_fleet}{Fleet}}, EVERYTHING is going to be stored as an \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \textcolor{keywordflow}{for} ms}
