...
\begin{center}
\leavevmode
\includegraphics[width=262pt]{class_combinators_1_1_reduction_exception__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=262pt]{class_combinators_1_1_reduction_exception__coll__graph}
\end{center}
\end{figure}
