...
\DoxyCodeLine{        \textcolor{keyword}{const} \textcolor{keyword}{auto} out = \mbox{\hyperlink{class_callable_a4bba2177c3bb6c48dff14e9d189edca2}{call}}(x.input, \textcolor{stringliteral}{""}); }
...
\DoxyCodeLine{        prefix = prefix+\textcolor{stringliteral}{"\#\(\backslash\)n\#"} +  this-\/>\mbox{\hyperlink{class_callable_a4bba2177c3bb6c48dff14e9d189edca2}{call}}(\textcolor{stringliteral}{""}, \textcolor{stringliteral}{"<err>"}).string() + \textcolor{stringliteral}{"\(\backslash\)n"};}
