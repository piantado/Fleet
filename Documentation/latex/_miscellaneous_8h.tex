...
{\footnotesize template$<$typename T $>$ }\\T \mbox{\hyperlink{_miscellaneous_8h_aaa40c0e9f61d6084c2b1af0adbf8b5b7}{weighted\+\_\+quantile}} (std\+::vector$<$ std\+::pair$<$ T, double $>$$>$ \&v, double q)
\end{DoxyCompactItemize}
...
\end{DoxyReturn}
\mbox{\Hypertarget{_miscellaneous_8h_aaa40c0e9f61d6084c2b1af0adbf8b5b7}\label{_miscellaneous_8h_aaa40c0e9f61d6084c2b1af0adbf8b5b7}} 
\index{Miscellaneous.h@{Miscellaneous.h}!weighted\_quantile@{weighted\_quantile}}
\index{weighted\_quantile@{weighted\_quantile}!Miscellaneous.h@{Miscellaneous.h}}
\doxysubsubsection{\texorpdfstring{weighted\_quantile()}{weighted\_quantile()}}
{\footnotesize\ttfamily template$<$typename T $>$ \\
T weighted\+\_\+quantile (\begin{DoxyParamCaption}\item[{std\+::vector$<$ std\+::pair$<$ T, double $>$$>$ \&}]{v,  }\item[{double}]{q }\end{DoxyParamCaption})}


\begin{DoxyCode}{0}
\DoxyCodeLine{    Check \textcolor{keywordflow}{if} a type is a specialization of another}
\DoxyCodeLine{   \string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~\string~ */}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//https://stackoverflow.com/questions/16337610/how-\/to-\/know-\/if-\/a-\/type-\/is-\/a-\/specialization-\/of-\/stdvector}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{typename} Test, \textcolor{keyword}{template}<\textcolor{keyword}{typename}...> \textcolor{keyword}{class }Ref>}
\DoxyCodeLine{\textcolor{keyword}{struct }is\_specialization : std::false\_type \{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{template}<\textcolor{keyword}{typename}...> \textcolor{keyword}{class }Ref, \textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{\textcolor{keyword}{struct }is\_specialization<Ref<Args...>, Ref>: std::true\_type \{\};}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{/*}}
\end{DoxyCode}
 \begin{DoxyVerb}Weighted quantiles
\end{DoxyVerb}
