...
\begin{center}
\leavevmode
\includegraphics[width=223pt]{class_you_should_not_be_here_error__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=223pt]{class_you_should_not_be_here_error__coll__graph}
\end{center}
\end{figure}
