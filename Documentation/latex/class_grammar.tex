...
\item 
void \mbox{\hyperlink{class_grammar_a13e6a10b4707908a35e11b3afed14206}{change\+\_\+probability}} (const std\+::string \&s, const double newp)
\item 
...
\item 
{\footnotesize template$<$typename T , typename... args$>$ }\\void \mbox{\hyperlink{class_grammar_a2efa36c5150274bb68288e906b92874e}{add}} (std\+::string fmt, \mbox{\hyperlink{struct_primitive}{Primitive}}$<$ T, args... $>$ \&b, double p=1.\+0, int a=0)
\item 
...
void \mbox{\hyperlink{class_grammar_aec8c4c5ff062343bce0438470910efe5}{remove\+\_\+all}} (\mbox{\hyperlink{_nonterminal_8h_a1c5bfe9b903f69c83bbde5da7035fef3}{nonterminal\+\_\+t}} \mbox{\hyperlink{class_grammar_ac7ec043aec5203a2cfac44f9cec50132}{nt}})
\begin{DoxyCompactList}\small\item\em Remove all the nonterminals of this type from the grammar. N\+O\+TE\+: This is generally a {\itshape really} bad idea unless you know what you are doing. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em A wrapper to catch Depth\+Excpetions and retry. This means that defaultly we try to generate G\+E\+N\+E\+R\+A\+T\+E\+\_\+\+D\+E\+P\+T\+H\+\_\+\+E\+X\+C\+E\+P\+T\+I\+O\+N\+\_\+\+R\+E\+T\+R\+I\+ES times and if A\+LL of them fail, we throw an assert error. Presumably, unless the grammar is terrible one of them will work. This makes our Depth\+Exceptions generally silent to the outside since they won\textquotesingle{}t call \+\_\+\+\_\+generate typically. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Compute a vector of counts of how often each rule was used, in a {\itshape standard} order given by iterating over nts and then iterating over rules. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename K , typename T $>$ }\\std\+::vector$<$ size\+\_\+t $>$ \mbox{\hyperlink{class_grammar_aac5f819cd2708982cb22caa49949c225}{get\+\_\+counts}} (const std\+::map$<$ K, T $>$ \&v) const
\item 
...
\begin{DoxyCompactList}\small\item\em This computes the expected length of productions from this grammar, counting terminals and nonterminals as 1 each N\+O\+TE\+: We can do this smarter with a matrix eigenvalues, but its a bit less flexible/extensible. \end{DoxyCompactList}\item 
...
\item 
static const size\+\_\+t \mbox{\hyperlink{class_grammar_ab0add2774a090ed81975c0a2e4f29a71}{G\+E\+N\+E\+R\+A\+T\+E\+\_\+\+D\+E\+P\+T\+H\+\_\+\+E\+X\+C\+E\+P\+T\+I\+O\+N\+\_\+\+R\+E\+T\+R\+I\+ES}} = 1000
\end{DoxyCompactItemize}
...
\mbox{\Hypertarget{class_grammar_a263ca363a94f8f3ae4d32012c90e9432}\label{class_grammar_a263ca363a94f8f3ae4d32012c90e9432}} 
\index{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}!\_\_generate@{\_\_generate}}
\index{\_\_generate@{\_\_generate}!Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}}
\doxysubsubsection{\texorpdfstring{\_\_generate()}{\_\_generate()}}
{\footnotesize\ttfamily template$<$typename \+\_\+input\+\_\+t , typename \+\_\+output\+\_\+t , typename... G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES$>$ \\
\mbox{\hyperlink{class_node}{Node}} \mbox{\hyperlink{class_grammar}{Grammar}}$<$ \+\_\+input\+\_\+t, \+\_\+output\+\_\+t, G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES $>$\+::\+\_\+\+\_\+generate (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{_nonterminal_8h_a1c5bfe9b903f69c83bbde5da7035fef3}{nonterminal\+\_\+t}}}]{ntfrom = {\ttfamily \mbox{\hyperlink{class_grammar_ac7ec043aec5203a2cfac44f9cec50132}{nt}}$<$\mbox{\hyperlink{class_grammar_aee7630d758322022048d06605b07e697}{output\+\_\+t}}$>$()},  }\item[{unsigned long}]{depth = {\ttfamily 0} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\end{DoxyReturn}
N\+O\+TE\+: this may throw a if the grammar recurses too far (usually that means the grammar is improper)\mbox{\Hypertarget{class_grammar_a2efa36c5150274bb68288e906b92874e}\label{class_grammar_a2efa36c5150274bb68288e906b92874e}} 
...
void \mbox{\hyperlink{class_grammar}{Grammar}}$<$ \+\_\+input\+\_\+t, \+\_\+output\+\_\+t, G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES $>$\+::add (\begin{DoxyParamCaption}\item[{std\+::string}]{fmt,  }\item[{\mbox{\hyperlink{struct_primitive}{Primitive}}$<$ T, args... $>$ \&}]{b,  }\item[{double}]{p = {\ttfamily 1.0},  }\item[{int}]{a = {\ttfamily 0} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\mbox{\Hypertarget{class_grammar_a13e6a10b4707908a35e11b3afed14206}\label{class_grammar_a13e6a10b4707908a35e11b3afed14206}} 
\index{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}!change\_probability@{change\_probability}}
\index{change\_probability@{change\_probability}!Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}}
\doxysubsubsection{\texorpdfstring{change\_probability()}{change\_probability()}}
{\footnotesize\ttfamily template$<$typename \+\_\+input\+\_\+t , typename \+\_\+output\+\_\+t , typename... G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES$>$ \\
void \mbox{\hyperlink{class_grammar}{Grammar}}$<$ \+\_\+input\+\_\+t, \+\_\+output\+\_\+t, G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES $>$\+::change\+\_\+probability (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{s,  }\item[{const double}]{newp }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
A wrapper to catch Depth\+Excpetions and retry. This means that defaultly we try to generate G\+E\+N\+E\+R\+A\+T\+E\+\_\+\+D\+E\+P\+T\+H\+\_\+\+E\+X\+C\+E\+P\+T\+I\+O\+N\+\_\+\+R\+E\+T\+R\+I\+ES times and if A\+LL of them fail, we throw an assert error. Presumably, unless the grammar is terrible one of them will work. This makes our Depth\+Exceptions generally silent to the outside since they won\textquotesingle{}t call \+\_\+\+\_\+generate typically. 
...
\end{DoxyReturn}
\mbox{\Hypertarget{class_grammar_a354a5d9bdaced96748c599bc7c3bd64a}\label{class_grammar_a354a5d9bdaced96748c599bc7c3bd64a}} 
...
\doxysubsubsection{\texorpdfstring{get\_counts()}{get\_counts()}\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
{\footnotesize\ttfamily template$<$typename \+\_\+input\+\_\+t , typename \+\_\+output\+\_\+t , typename... G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES$>$ \\
...
\end{DoxyReturn}
\mbox{\Hypertarget{class_grammar_aac5f819cd2708982cb22caa49949c225}\label{class_grammar_aac5f819cd2708982cb22caa49949c225}} 
\index{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}!get\_counts@{get\_counts}}
\index{get\_counts@{get\_counts}!Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}}
\doxysubsubsection{\texorpdfstring{get\_counts()}{get\_counts()}\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
{\footnotesize\ttfamily template$<$typename \+\_\+input\+\_\+t , typename \+\_\+output\+\_\+t , typename... G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES$>$ \\
template$<$typename K , typename T $>$ \\
std\+::vector$<$size\+\_\+t$>$ \mbox{\hyperlink{class_grammar}{Grammar}}$<$ \+\_\+input\+\_\+t, \+\_\+output\+\_\+t, G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES $>$\+::get\+\_\+counts (\begin{DoxyParamCaption}\item[{const std\+::map$<$ K, T $>$ \&}]{v }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}

\mbox{\Hypertarget{class_grammar_a336d72ee766941a3ac8c6507c2022a83}\label{class_grammar_a336d72ee766941a3ac8c6507c2022a83}} 
\index{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}!get\_counts@{get\_counts}}
\index{get\_counts@{get\_counts}!Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}}
\doxysubsubsection{\texorpdfstring{get\_counts()}{get\_counts()}\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
{\footnotesize\ttfamily template$<$typename \+\_\+input\+\_\+t , typename \+\_\+output\+\_\+t , typename... G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES$>$ \\
template$<$typename T $>$ \\
...
This computes the expected length of productions from this grammar, counting terminals and nonterminals as 1 each N\+O\+TE\+: We can do this smarter with a matrix eigenvalues, but its a bit less flexible/extensible. 
...
\mbox{\Hypertarget{class_grammar_aec8c4c5ff062343bce0438470910efe5}\label{class_grammar_aec8c4c5ff062343bce0438470910efe5}} 
\index{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}!remove\_all@{remove\_all}}
\index{remove\_all@{remove\_all}!Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}}
\doxysubsubsection{\texorpdfstring{remove\_all()}{remove\_all()}}
{\footnotesize\ttfamily template$<$typename \+\_\+input\+\_\+t , typename \+\_\+output\+\_\+t , typename... G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES$>$ \\
void \mbox{\hyperlink{class_grammar}{Grammar}}$<$ \+\_\+input\+\_\+t, \+\_\+output\+\_\+t, G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES $>$\+::remove\+\_\+all (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{_nonterminal_8h_a1c5bfe9b903f69c83bbde5da7035fef3}{nonterminal\+\_\+t}}}]{nt }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Remove all the nonterminals of this type from the grammar. N\+O\+TE\+: This is generally a {\itshape really} bad idea unless you know what you are doing. 
...
\mbox{\Hypertarget{class_grammar_ab0add2774a090ed81975c0a2e4f29a71}\label{class_grammar_ab0add2774a090ed81975c0a2e4f29a71}} 
\index{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}!GENERATE\_DEPTH\_EXCEPTION\_RETRIES@{GENERATE\_DEPTH\_EXCEPTION\_RETRIES}}
\index{GENERATE\_DEPTH\_EXCEPTION\_RETRIES@{GENERATE\_DEPTH\_EXCEPTION\_RETRIES}!Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$@{Grammar$<$ \_input\_t, \_output\_t, GRAMMAR\_TYPES $>$}}
\doxysubsubsection{\texorpdfstring{GENERATE\_DEPTH\_EXCEPTION\_RETRIES}{GENERATE\_DEPTH\_EXCEPTION\_RETRIES}}
{\footnotesize\ttfamily template$<$typename \+\_\+input\+\_\+t , typename \+\_\+output\+\_\+t , typename... G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES$>$ \\
const size\+\_\+t \mbox{\hyperlink{class_grammar}{Grammar}}$<$ \+\_\+input\+\_\+t, \+\_\+output\+\_\+t, G\+R\+A\+M\+M\+A\+R\+\_\+\+T\+Y\+P\+ES $>$\+::G\+E\+N\+E\+R\+A\+T\+E\+\_\+\+D\+E\+P\+T\+H\+\_\+\+E\+X\+C\+E\+P\+T\+I\+O\+N\+\_\+\+R\+E\+T\+R\+I\+ES = 1000\hspace{0.3cm}{\ttfamily [static]}}
