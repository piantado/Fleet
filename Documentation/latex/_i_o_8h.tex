...
\begin{DoxyCompactList}\small\item\em Load data -- divides in columns at the delimiter. N\+O\+TE\+: we are required to say whetehr we skip a header (first line) or not. Checks tha tthere are exactly N on each line. So we can use like\+: ~\newline
...
Load data -- divides in columns at the delimiter. N\+O\+TE\+: we are required to say whetehr we skip a header (first line) or not. Checks tha tthere are exactly N on each line. So we can use like\+: ~\newline
