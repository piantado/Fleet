...
public:
	...
	virtual void push_program(Program& s, short j) override {
	 ...
	 virtual vmstatus_t dispatch_custom(Instruction i, VirtualMachinePool<VirtualMachineState<t_input,t_output>>* pool, VirtualMachineState<t_input,t_output>* vms,  Dispatchable<t_input, t_output>* loader ) override {
