 ...
 */
template<typename HYP, typename _input_t=HYP::input_t, typename _response_t=std::map<typename HYP::output_t,size_t>, typename _data_t=HYP::data_t>
struct HumanDatum {
	...
	response_t     responses; // how many of each type of response do you see?
