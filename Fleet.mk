...
# Include directories
FLEET_INCLUDE=-I$(FLEET_ROOT)/src/ -I$(FLEET_ROOT)/src/Inference -I$(FLEET_ROOT)/src/Hypotheses -I$(FLEET_ROOT)/src/VirtualMachine -I$(FLEET_ROOT)/src/Statistics -I$(FLEET_ROOT)/src/Grammar -I$(FLEET_ROOT)/src/GrammarInference
