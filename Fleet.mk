...
FLEET_FLAGS= -std=c++20 -Wall -fdiagnostics-color=auto -Wimplicit-fallthrough -Wall -Wshadow -Wextra -Wextra-semi -Wpedantic -Wvla -Wnull-dereference -Wswitch-enum -Wno-unused-parameter -fvar-tracking-assignments -Wduplicated-cond -Wduplicated-branches -Wsuggest-override -march=native -ftemplate-backtrace-limit=0 -fstack-protector-strong --param max-inline-insns-recursive=100000 -fcoroutines -fno-non-call-exceptions -fwrapv 
## Might add -Werror ?
