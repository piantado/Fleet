...
# for(language in c("An", "ABn", "AnBn", "AB", "ABAnBn", "AnB2n", "AnBm", "AnBkCn", "XXR", "AAA", "AAAA", "Count", "AnBnCn", "AnBnC2n", "Dyck", "XX",  "XXI", "XY", "AnBmCmAn", "AnBmCnDm", "ABA", "ABB", "GoldenMean", "Even", "AnBnCnDn", "A2en", "ABnen", "AnCBn")) {
