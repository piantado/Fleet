...
for(language in c( "Saffran", "ABA", "ABB", "Milne", "Elman", "MorganNewport", "MorganMeierNewport", "NewportAslin",  "Braine66",  "HudsonKamNewport60", "Gomez2", "Gomez6",  "Gomez12", "Man", "ReederNewportAslin", "Reber", "BerwickPilato")) {
